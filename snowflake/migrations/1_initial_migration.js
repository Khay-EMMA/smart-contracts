...
const StringUtils = artifacts.require(
  "./resolvers/ClientRaindrop/StringUtils.sol"
);
const ClientRaindrop = artifacts.require(
  "./resolvers/ClientRaindrop/ClientRaindrop.sol"
);
